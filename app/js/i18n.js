...
const TRANSLATIONS = {
  ar: {
    ...
    // Round 2 rules
    r2_rule1: 'مواجهة البداية ⚔️: يبدأ لاعبان بالضغط السريع. الإجابة الأسرع والأصح تمنح فريقه خيار "اللعب" أو "التمرير".',
    r2_rule2: 'اللعب الفردي 👤: الفريق الذي يملك اللوحة يجب أن يجيب أفراده بالدور وبشكل فردي تماماً وبدون أي تشاور.',
    r2_rule3: 'تجميع البنك 🏦: كل إجابة تُكشف قيمتها تضاف إلى "بنك" مؤقت للجولة ولا تُحتسب كفوز حتى تنتهي اللوحة.',
    r2_rule4: 'الإنذارات (الأخطاء) ❌: أي إجابة خاطئة تسجل كـ"إنذار". 3 إنذارات متتالية تُنهي دور الفريق الأول فوراً.',
    r2_rule5: 'مرحلة السرقة 🚨: يحصل الفريق الثاني على فرصة تشاور جماعية لإعطاء "إجابة واحدة" لمحاولة سرقة اللوحة.',
    r2_rule6: 'حسم البنك 🔄: سرقة صحيحة = البنك يتحول بالكامل للخصم. سرقة خاطئة = يعود البنك للفريق الأول (تتضاعف النقاط كل سؤال 1x, 2x, 3x).',
  ...
  en: {
    ...
    r2_rule1: 'Face-Off ⚔️: A player from each team buzzes in. The best answer decides who "Plays" or "Passes".',
    r2_rule2: 'Solo Play 👤: The playing team answers one by one. Group consulting is STRICTLY PROHIBITED!',
    r2_rule3: 'Building the Bank 🏦: Revealed answers deposit their value into a temporary Bank, not directly to score.',
    r2_rule4: 'Strikes ❌: Every wrong answer earns a Strike. Accruing 3 Strikes immediately freezes the board.',
    r2_rule5: 'The Steal 🚨: The opposing team now groups up and consults to give ONE final answer to steal the board.',
    r2_rule6: 'Resolution 🔄: A correct steal gives them the whole Bank. Wrong steal returns it to Team 1. Point values multiply every board (1x, 2x, 3x)!',

    r3_rule1: 'Extremely fast questions — correct answers worth +20 pts',
    r3_rule2: 'Wrong answer = immediately bounces to the opposing team',
    r3_rule3: 'Last 3 questions = CLUTCH MODE 🔴 — worth +50 pts each!',
    r3_rule4: 'Huge swings are possible—never give up until the buzzer rings',
