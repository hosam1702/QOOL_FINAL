const QUESTION_DB = {
  "round1": [
    ...
    {
      "category": "islamic",
      "ar": "ما الكتب السماوية المذكورة في القرآن الكريم؟\n(الإجابة: القرآن — التوراة — الإنجيل — الزبور — صحف إبراهيم وموسى)",
      "en": "Name the divine books mentioned in the Quran.\n(Ans: Quran — Torah — Gospel — Psalms — Scrolls of Abraham and Moses)"
    },
    {
      "category": "islamic",
      "ar": "اذكر بعضاً من أسماء الله الحسنى المذكورة في القرآن.\n(الإجابة: الله — الرحمن — الرحيم — الملك — القدوس — السلام — المؤمن — المهيمن — العزيز — الجبار — المتكبر — الخالق — البارئ — المصور)",
      "en": "Name some of the beautiful names of Allah mentioned in the Quran.\n(Ans: Allah — Ar-Rahman — Ar-Rahim — Al-Malik — Al-Quddus — As-Salam — Al-Mu'min — Al-Muhaymin — Al-Aziz — Al-Jabbar — Al-Mutakabbir — Al-Khaliq — Al-Bari' — Al-Musawwir)"
    },
    {
      "category": "islamic",
      "ar": "من هم الأنبياء والرسل المذكورون في القرآن الكريم؟\n(الإجابة: آدم — نوح — إبراهيم — إسماعيل — إسحاق — يعقوب — يوسف — موسى — هارون — داود — سليمان — أيوب — يونس — عيسى — محمد — إدريس — هود — صالح — لوط — شعيب — ذو الكفل — إلياس — اليسع — زكريا — يحيى [عليهم السلام])",
      "en": "Name the Prophets and Messengers mentioned in the Quran.\n(Ans: Adam — Noah — Abraham — Ishmael — Isaac — Jacob — Joseph — Moses — Aaron — David — Solomon — Job — Jonah — Jesus — Muhammad — Idris — Hud — Salih — Lot — Shu'ayb — Dhul-Kifl — Elijah — Elisha — Zechariah — John [peace be upon them])"
    },
    {
      "category": "islamic",
      "ar": "ما الصلوات المفروضة في اليوم والليلة؟\n(الإجابة: الفجر — الظهر — العصر — المغرب — العشاء)",
      "en": "What are the five obligatory daily prayers?\n(Ans: Fajr — Dhuhr — Asr — Maghrib — Isha)"
    },
    {
      "category": "islamic",
      "ar": "ما شروط صحة الصلاة؟\n(الإجابة: الإسلام — العقل — التمييز — رفع الحدث — طهارة الخبث [الثوب والبدن والمكان] — ستر العورة — دخول الوقت — استقبال القبلة — النية)",
      "en": "What are the conditions for the validity of prayer?\n(Ans: Islam — Sanity — Age of discernment — Ritual purity — Cleanliness of body, clothes, and place — Covering the 'Awrah — Time of prayer — Facing the Qiblah — Intention)"
    },
    {
      "category": "islamic",
      "ar": "ما أبرز الأعمال المستحبة في شهر رمضان؟\n(الإجابة: الصيام — قيام الليل [التراويح] — تلاوة القرآن — الصدقة — العمرة — تحري ليلة القدر — الاعتكاف — إطعام الطعام)",
      "en": "What are the most prominent recommended acts during Ramadan?\n(Ans: Fasting — Night prayer [Taraweeh] — Reciting the Quran — Charity — Umrah — Seeking Laylat al-Qadr — I'tikaf — Feeding others)"
    },
    {
      "category": "islamic",
      "ar": "ما مناسك الحج بالترتيب؟\n(الإجابة: الإحرام — الطواف — السعي — يوم التروية [بمنى] — الوقوف بعرفة — المبيت بمزدلفة — رمي جمرة العقبة — النحر — الحلق أو التقصير — طواف الإفاضة — رمي الجمرات في أيام التشريق — طواف الوداع)",
      "en": "What are the rituals of Hajj in order?\n(Ans: Ihram — Tawaf — Sa'i — Tarwiyah Day [in Mina] — Standing at Arafat — Staying in Muzdalifah — Stoning Jamrat al-Aqabah — Sacrifice — Shaving or cutting hair — Tawaf al-Ifadah — Stoning Jamarat during Tashreeq days — Farewell Tawaf)"
    },
    {
      "category": "islamic",
      "ar": "من هم الصحابة العشرة المبشرون بالجنة؟\n(الإجابة: أبو بكر الصديق — عمر بن الخطاب — عثمان بن عفان — علي بن أبي طالب — طلحة بن عبيد الله — الزبير بن العوام — عبد الرحمن بن عوف — سعد بن أبي وقاص — سعيد بن زيد — أبو عبيدة عامر بن الجراح [رضي الله عنهم])",
      "en": "Who are the ten companions promised Paradise?\n(Ans: Abu Bakr al-Siddiq — Umar ibn al-Khattab — Uthman ibn Affan — Ali ibn Abi Talib — Talhah ibn Ubaydullah — Zubayr ibn al-Awwam — Abd al-Rahman ibn Awf — Sa'd ibn Abi Waqqas — Sa'id ibn Zayd — Abu Ubaydah ibn al-Jarrah [may Allah be pleased with them])"
    },
    {
      "category": "islamic",
      "ar": "من هن أمهات المؤمنين (زوجات النبي ﷺ)؟\n(الإجابة: خديجة بنت خويلد — سودة بنت زمعة — عائشة بنت أبي بكر — حفصة بنت عمر — زينب بنت خزيمة — أم سلمة — زينب بنت جحش — جويرية بنت الحارث — أم حبيبة — صفية بنت حيي — ميمونة بنت الحارث [رضي الله عنهن])",
      "en": "Who are the Mothers of the Believers (wives of the Prophet ﷺ)?\n(Ans: Khadijah bint Khuwaylid — Sawdah bint Zam'ah — Aisha bint Abi Bakr — Hafsah bint Umar — Zaynab bint Khuzaymah — Umm Salamah — Zaynab bint Jahsh — Juwayriyah bint al-Harith — Umm Habibah — Safiyyah bint Huyayy — Maymunah bint al-Harith [may Allah be pleased with them])"
    },
    {
      "category": "islamic",
      "ar": "ما أركان (فروض) الوضوء؟\n(الإجابة: النية — غسل الوجه [ومنه المضمضة والاستنشاق] — غسل اليدين إلى المرفقين — مسح الرأس — غسل الرجلين إلى الكعبين — الترتيب — الموالاة)",
      "en": "What are the pillars (obligations) of Wudu?\n(Ans: Intention — Washing the face [including rinsing mouth and nose] — Washing arms to elbows — Wiping the head — Washing feet to ankles — Sequence — Continuity)"
    },
    {
      "category": "islamic",
      "ar": "ما أبرز السور المكية في القرآن الكريم؟\n(الإجابة: الأنعام — الأعراف — يونس — هود — يوسف — الكهف — مريم — طه — الأنبياء — الفرقان)",
      "en": "Name some of the prominent Meccan Surahs in the Quran.\n(Ans: Al-An'am — Al-A'raf — Yunus — Hud — Yusuf — Al-Kahf — Maryam — Taha — Al-Anbiya' — Al-Furqan)"
    },
    {
      "category": "islamic",
      "ar": "ما أبرز غزوات النبي ﷺ؟\n(الإجابة: بدر — أحد — الخندق — خيبر — مؤتة — فتح مكة — حنين — تبوك)",
      "en": "Name the prominent battles of the Prophet ﷺ.\n(Ans: Badr — Uhud — Al-Khandaq [The Trench] — Khaybar — Mu'tah — Conquest of Mecca — Hunayn — Tabuk)"
    },
    {
      "category": "islamic",
      "ar": "من هم الخلفاء الراشدون؟\n(الإجابة: أبو بكر الصديق — عمر بن الخطاب — عثمان بن عفان — علي بن أبي طالب [رضي الله عنهم])",
      "en": "Who are the Rightly Guided Caliphs?\n(Ans: Abu Bakr al-Siddiq — Umar ibn al-Khattab — Uthman ibn Affan — Ali ibn Abi Talib [may Allah be pleased with them])"
    },
    {
      "category": "islamic",
      "ar": "ما نواقض الوضوء؟\n(الإجابة: الخارج من السبيلين — زوال العقل [بنوم أو غيره] — مس الفرج باليد مباشرة — أكل لحم الإبل — الردة عن الإسلام)",
      "en": "What are the invalidators of Wudu?\n(Ans: Discharges from the two passages — Loss of consciousness [by sleep or otherwise] — Directly touching the private parts — Eating camel meat — Apostasy from Islam)"
    },
    {
      "category": "islamic",
      "ar": "ما أنواع الزكاة؟\n(الإجابة: زكاة النقدين [الذهب والفضة وما يقوم مقامهما] — زكاة عروض التجارة — زكاة بهيمة الأنعام — زكاة الخارج من الأرض [الحبوب والثمار] — زكاة الفطر)",
      "en": "What are the types of Zakat?\n(Ans: Zakat on money and precious metals — Zakat on business inventory — Zakat on livestock — Zakat on agricultural produce — Zakat al-Fitr)"
    },
    {
      "category": "islamic",
      "ar": "ما المساجد الثلاثة التي تُشد إليها الرحال؟\n(الإجابة: المسجد الحرام — المسجد النبوي — المسجد الأقصى)",
      "en": "What are the three mosques to which one may travel for worship?\n(Ans: Al-Masjid al-Haram — Al-Masjid al-Nabawi — Al-Masjid al-Aqsa)"
    },
    {
      "category": "islamic",
      "ar": "ما أسماء سورة الفاتحة؟\n(الإجابة: الفاتحة — أم الكتاب — أم القرآن — السبع المثاني — القرآن العظيم — الشافية — الرقية — الكافية — الوافية — الأساس — الحمد)",
      "en": "What are the names of Surah Al-Fatihah?\n(Ans: Al-Fatihah — Umm al-Kitab — Umm al-Quran — As-Sab' al-Mathani — Al-Quran al-Azim — Ash-Shafiyah — Ar-Ruqyah — Al-Kafiyah — Al-Wafiyah — Al-Asas — Al-Hamd)"
    },
    {
      "category": "islamic",
      "ar": "ما الكبائر في الإسلام؟\n(الإجابة: الشرك بالله — السحر — قتل النفس التي حرم الله إلا بالحق — أكل الربا — أكل مال اليتيم — التولي يوم الزحف — قذف المحصنات الغافلات المؤمنات)",
      "en": "What are the major sins in Islam?\n(Ans: Associating partners with Allah — Sorcery — Unjustified murder — Consuming usury [Riba] — Consuming an orphan's wealth — Fleeing from the battlefield — Accusing chaste, believing women of adultery)"
    },
    {
      "category": "islamic",
      "ar": "ما أيام الصيام المستحبة؟\n(الإجابة: يوم عرفة — يوم عاشوراء [مع يوم قبله أو بعده] — الاثنين والخميس — الأيام البيض [13، 14، 15 من كل شهر هجري] — ست من شوال — صيام داود [صيام يوم وإفطار يوم])",
      "en": "What are the recommended days for fasting?\n(Ans: Day of Arafah — Day of Ashura [with a day before or after] — Mondays and Thursdays — The White Days [13th, 14th, 15th of Hijri month] — Six days of Shawwal — Fasting of David [fasting alternate days])"
    },
    {
      "category": "islamic",
      "ar": "من هم الملائكة المذكورون بأسمائهم في القرآن والسنة؟\n(الإجابة: جبريل — ميكائيل — إسرافيل — ملك الموت — مالك [خازن النار] — رضوان [خازن الجنة] — منكر ونكير — هاروت وماروت)",
      "en": "Name the angels mentioned by name in the Quran and Sunnah.\n(Ans: Jibril [Gabriel] — Mika'il [Michael] — Israfil — Angel of Death — Malik [keeper of Hellfire] — Ridwan [keeper of Paradise] — Munkar and Nakir — Harut and Marut)"
    },
    {
      "category": "islamic",
      "ar": "ما شروط وجوب الزكاة؟\n(الإجابة: الإسلام — الحرية — ملك النصاب — استقرار الملك — مضي الحول [في غير المعشرات])",
      "en": "What are the conditions for the obligation of Zakat?\n(Ans: Islam — Freedom — Reaching the Nisab [minimum amount] — Absolute ownership — The passing of a lunar year [except for crops])"
    },
    {
      "category": "islamic",
      "ar": "ما أبواب الجنة الثمانية؟\n(الإجابة: باب الصلاة — باب الجهاد — باب الريان — باب الصدقة — باب الحج — باب الكاظمين الغيظ والعافين عن الناس — باب المتوكلين [الباب الأيمن] — باب التوبة [أو الذكر])",
      "en": "What are the eight gates of Paradise?\n(Ans: Gate of Prayer — Gate of Jihad — Gate of Rayyan — Gate of Charity — Gate of Hajj — Gate of Those Who Control Their Anger — Gate of Those Who Trust in Allah [The Right Gate] — Gate of Repentance [or Dhikr])"
    },
    {
      "category": "islamic",
      "ar": "من هم مؤذنو النبي ﷺ؟\n(الإجابة: بلال بن رباح — عبد الله بن أم مكتوم — أبو محذورة — سعد القرظ [رضي الله عنهم])",
      "en": "Who were the Mu'adhins (callers to prayer) of the Prophet ﷺ?\n(Ans: Bilal ibn Rabah — Abdullah ibn Umm Maktum — Abu Mahdhura — Sa'd al-Qurad [may Allah be pleased with them])"
    },
    {
      "category": "islamic",
      "ar": "ما أيام التشريق؟\n(الإجابة: 11ذي الحجة— 13ذي الحجة—12ذي الحجة)",
      "en": "What are the Days of Tashreeq?\n(Ans: 11th, 12th, and 13th of Dhu al-Hijjah)"
    },
    {
      "category": "islamic",
      "ar": "من هم أولو العزم من الرسل؟\n(الإجابة: نوح — إبراهيم — موسى — عيسى — محمد [عليهم الصلاة والسلام])",
      "en": "Who are the Messengers of Firm Resolve (Ulu'l 'Azm)?\n(Ans: Noah — Abraham — Moses — Jesus — Muhammad [peace be upon them])"
    },
    {
      "category": "islamic",
      "ar": "ما كتب الحديث الستة الكبرى؟\n(الإجابة: صحيح البخاري — صحيح مسلم — سنن أبي داود — سنن الترمذي — سنن النسائي — سنن ابن ماجه)",
      "en": "What are the six major Hadith collections?\n(Ans: Sahih al-Bukhari — Sahih Muslim — Sunan Abi Dawud — Sunan al-Tirmidhi — Sunan al-Nasa'i — Sunan Ibn Majah)"
    },
    {
      "category": "islamic",
      "ar": "ما أسماء يوم القيامة في القرآن الكريم؟\n(الإجابة: يوم القيامة — يوم الحساب — يوم الدين — يوم الفصل — الساعة — يوم البعث — الحاقة — القارعة — الطامة الكبرى — الصاخة — الغاشية — يوم الوعيد — يوم الحسرة)",
      "en": "What are the names of the Day of Judgment in the Quran?\n(Ans: Day of Resurrection — Day of Reckoning — Day of Religion — Day of Separation — The Hour — Day of Awakening — The Inevitable — The Striking Calamity — The Greatest Catastrophe — The Deafening Blast — The Overwhelming — Day of Threat — Day of Regret)"
    },
    {
      "category": "islamic",
      "ar": "ما أشهر الحج؟\n(الإجابة: شوال — ذو القعدة — ذو الحجة [أو عشر من ذي الحجة على قول])",
      "en": "What are the months of Hajj?\n(Ans: Shawwal — Dhu al-Qi'dah — Dhu al-Hijjah [or the first ten days of Dhu al-Hijjah according to some])"
    }
  ],
  "round2": [
    {
  ...
  "round3": [
    ...
    {
      "category": "general",
      "ar": "أي دولة تمتلك أكبر احتياطيات نفطية في الشرق الأوسط؟\n(الإجابة: المملكة العربية السعودية)",
      "en": "Which country has the largest oil reserves in the Middle East?\n(Ans: Saudi Arabia)"
    },
    {
      "category": "general",
      "ar": "ما هي اللغة الرسمية للإمارات العربية المتحدة؟\n(الإجابة: العربية)",
      "en": "What is the official language of the United Arab Emirates?\n(Ans: Arabic)"
    },
    {
      "category": "general",
      "ar": "كم عدد الكواكب في نظامنا الشمسي؟\n(الإجابة: ٨)",
    ...
    {
      "category": "general",
      "ar": "ما هو أطول مبنى في العالم؟\n(الإجابة: برج خليفة (دبي))",
    ...
    {
      "category": "general",
      "ar": "ما هي أصغر دولة في العالم؟\n(الإجابة: مدينة الفاتيكان)",
      "en": "What is the smallest country in the world?\n(Ans: Vatican City)"
    },
    {
      "category": "general",
      "ar": "أي غاز تمتصه النباتات من الغلاف الجوي؟\n(الإجابة: ثاني أكسيد الكربون (CO₂))",
      "en": "Which gas do plants absorb from the atmosphere?\n(Ans: Carbon dioxide (CO₂))"
    },
    {
      "category": "general",
      "ar": "ما الرياضة التي تُلعب في بطولة ويمبلدون؟\n(الإجابة: التنس)",
      "en": "What sport is played at Wimbledon?\n(Ans: Tennis)"
    },
    {
      "category": "general",
      "ar": "أي دولة استضافت كأس العالم FIFA 2022؟\n(الإجابة: قطر)",
      "en": "Which country hosted the 2022 FIFA World Cup?\n(Ans: Qatar)"
    },
    {
      "category": "general",
      "ar": "ما هي عملة مصر؟\n(الإجابة: الجنيه المصري)",
      "en": "What is the currency of Egypt?\n(Ans: Egyptian Pound)"
    },
    {
      "category": "general",
      "ar": "أي عجائب الدنيا القديمة كانت في الإسكندرية بمصر؟\n(الإجابة: منارة الإسكندرية)",
      "en": "Which ancient wonder was located in Alexandria, Egypt?\n(Ans: The Lighthouse of Alexandria)"
    },
    {
      "category": "general",
      "ar": "ما هي سرعة الضوء (تقريباً)؟\n(الإجابة: ٣٠٠٬٠٠٠ كم/ث)",
    ...
    {
      "category": "general",
      "ar": "أي دولة تضم مدينة البتراء الأثرية؟\n(الإجابة: الأردن)",
      "en": "Which country is home to the ancient city of Petra?\n(Ans: Jordan)"
    },
    {
      "category": "general",
      "ar": "ماذا يرمز اختصار DNA؟\n(الإجابة: حمض الديوكسيريبوز النووي)",
      "en": "What does DNA stand for?\n(Ans: Deoxyribonucleic Acid)"
    },
    {
      "category": "general",
      "ar": "في أي عام تأسست الأمم المتحدة؟\n(الإجابة: ١٩٤٥)",
      "en": "In which year was the United Nations founded?\n(Ans: 1945)"
    },
    {
      "category": "general",
      "ar": "أي إمبراطورية كانت تُحكم من القسطنطينية؟\n(الإجابة: الإمبراطورية البيزنطية (العثمانية))",
      "en": "Which empire was ruled from Constantinople?\n(Ans: The Byzantine (Ottoman) Empire)"
    },
    {
      "category": "general",
      "ar": "ما هو أكبر صحراء في العالم؟\n(الإجابة: القطب الجنوبي (صحراء باردة))",
      "en": "What is the largest desert in the world?\n(Ans: Antarctica (cold desert))"
    },
    {
      "category": "general",
      "ar": "أي عنصر له العدد الذري ٧٩؟\n(الإجابة: الذهب (Au))",
      "en": "Which element has the atomic number 79?\n(Ans: Gold (Au))"
    },
    {
      "category": "general",
      "ar": "أي دولة تمتلك أكبر عدد من الأهرامات في العالم؟\n(الإجابة: السودان)",
      "en": "Which country has the most pyramids in the world?\n(Ans: Sudan)"
    },
    {
      "category": "general",
      "ar": "ما اسم المضيق الذي يفصل بين أوروبا وأفريقيا؟\n(الإجابة: مضيق جبل طارق)",
      "en": "What is the name of the strait separating Europe and Africa?\n(Ans: Strait of Gibraltar)"
    },
    {
      "category": "general",
    ...
    {
      "category": "general",
      "ar": "ما هي اللغة الأكثر تحدثاً في العالم؟\n(الإجابة: الماندرين الصينية)",
      "en": "What is the most spoken language in the world?\n(Ans: Mandarin Chinese)"
    },
    {
      "category": "general",
      "ar": "أي دولة عربية كانت أول من منح المرأة حق التصويت؟\n(الإجابة: سوريا (١٩٤٩))",
      "en": "Which Arab country was the first to grant women the right to vote?\n(Ans: Syria (1949))"
    }
  ]
};
